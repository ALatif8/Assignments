	...
	if (!isset($_SESSION['username'])) {	// redirect user to login page in unsuccessful login
		...
		foreach($_SESSION['list'] as $key => $value){ //iterate over the array
			if(strstr($key, $search)==true){	//validate if any part of the search_input exist in the array
				echo "<br/>item \t |\t price <br> $key \t |\t $value<br> "; //dispaly the item & its price
		...
		echo "<br/>"."<a href='form.php'>Go to Shop!</a>"."<br/>"."<a href='search_items.php'>Go to Search!</a>"."<br/>"."<a href='sorted_arrays.php'>Go to Sort!</a>"."<br/>"."<a href='delete_form.php'>Go to Delete Input!</a>"."<br/>"."<a href='modify_form.php'>Go to Modify Form!</a><br/>";	//welcom message
	}
?>